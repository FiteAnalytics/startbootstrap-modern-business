...
<html lang="en">
    ...
    <body>
        ...
        <div class="jumbotron"  style="background-image: url(https://s3-us-west-1.amazonaws.com/fiteanalytics/website-assets/bridge_skyward.png); background-size: 100% 100%; opacity: 1.2">
            <h1 style="color: #EF785D">TRANSPARENCY, EFFICIENCY & INSIGHT for<br>Next-Generation CAPITAL MARKETS</h1><br>
            <p class="lead"><strong>Analytics for Cross-Asset Portfolios</strong></p>
