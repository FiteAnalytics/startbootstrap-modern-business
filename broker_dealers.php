...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <img class="img-fluid rounded" src="https://s3-us-west-1.amazonaws.com/fiteanalytics/website-assets/shot_rate_shocks.png" alt="">
        </div>
        <div class="col-lg-6">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
          <div class="card h-100 text-center card-no-border">
            <a href="#"><img class="card-img-top" style="width: 25%;" src="https://s3-us-west-1.amazonaws.com/fiteanalytics/website-assets/lightning_bolt.png" alt=""></a>
            <div class="card-body">
