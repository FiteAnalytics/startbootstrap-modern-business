    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <p>Asset Managers rely on timely market data and accurate analytics to make investment decisions. CMS:Portfolio
          combines broad coverage of fixed income securities with industry-leading analytics in a modern, sleek application.
          </p>
        </div>
      </div>
      <!-- /.row -->
